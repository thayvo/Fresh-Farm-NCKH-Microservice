# Nguon goc: output\recommendation-evaluation\run-recommendation-evaluation.ps1
# Duoc sao chep tu: D:\NCKH\DOAN\NCKH-FRESH-FARM\output\recommendation-evaluation\run-recommendation-evaluation.ps1
