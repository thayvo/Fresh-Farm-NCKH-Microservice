...
public class StatusController : LegacySellerControllerBase
{
    ...
    public async Task<IActionResult> Status(string searchTerm = "", int? statusTypeID = null, int page = 1)
    {
        ...
        var model = new List<SellerStatusViewModel>();
    ...
    public async Task<JsonResult> CreateStatus(SellerStatusViewModel status)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<JsonResult> EditStatus(SellerStatusViewModel status)
    {
    ...
    {
        const int pageSize = 6;
        var model = new List<SellerStatusTypeViewModel>();
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<JsonResult> CreateStatusType(SellerStatusTypeViewModel statusType)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<JsonResult> EditStatusType(SellerStatusTypeViewModel statusType)
    {
    ...
    private static SellerStatusViewModel MapStatus(StatusRowDto dto)
    {
        return new SellerStatusViewModel
        {
    ...
    private static SellerStatusTypeViewModel MapStatusType(StatusTypeRowDto dto)
    {
        return new SellerStatusTypeViewModel
        {
            StatusTypeID = dto.statusTypeID,
