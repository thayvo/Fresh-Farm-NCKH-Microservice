...
public sealed class CategoryController : LegacySellerControllerBase
{
    ...
    public async Task<IActionResult> ManageCategories(int? page, string? search)
    {
        ...
        if (!string.IsNullOrWhiteSpace(search))
        {
            ...
            categories = categories.Where(c =>
                c.CategoryName.ToLowerInvariant().Contains(keyword) ||
                (c.Description ?? string.Empty).ToLowerInvariant().Contains(keyword) ||
                (c.Slug ?? string.Empty).ToLowerInvariant().Contains(keyword)).ToList();
        ...
        return RenderCategoryView("~/Areas/Seller/Views/Category/ManageCategories.cshtml", result);
    }

    [HttpGet]
    public IActionResult Create()
    {
        return RenderCategoryView("~/Areas/Seller/Views/Category/Create.cshtml", new Category { IsActive = true });
    }
    ...
    public async Task<IActionResult> Create(Category category, IFormFile? imageFile)
    {
        ...
        {
            return RenderCategoryView("~/Areas/Seller/Views/Category/Create.cshtml", category);
        }
    ...
    public async Task<IActionResult> Edit(string slug)
    {
        ...
        return RenderCategoryView("~/Areas/Seller/Views/Category/Edit.cshtml", category);
    }
    ...
    private IActionResult RenderCategoryView<TModel>(string viewPath, TModel model)
    {
    ...
    private static Category MapCategory(ApiCategoryDto dto)
    {
        return new Category
        {
    ...
    private void TryDeleteCategoryImage(string? fileName)
    {
        try
        {
            if (string.IsNullOrWhiteSpace(fileName) || string.Equals(fileName, FallbackImg, StringComparison.OrdinalIgnoreCase))
            {
                return;
            }
